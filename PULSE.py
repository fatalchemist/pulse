...
class PULSE(torch.nn.Module):
    def __init__(self, cache_dir, verbose=True):
        ...
        with open_url("https://drive.google.com/uc?id=1RNIjPDQ0VoUREGyTaQ70INu5USKuwCgV", cache_dir=cache_dir, verbose=verbose) as f:
        ...
        if Path("gaussian_fit.pt").exists():
            ...
            with open_url("https://drive.google.com/uc?id=1hNysITDiQGR5QEWy2Ctb1BLokBrqiak_", cache_dir=cache_dir, verbose=verbose) as f:
